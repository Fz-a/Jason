...
(function (g) {
  ...
  const EYE_PLAYLIST = {
    sleeping: [13, 22, 4], waking: [13], idle: [0, 8, 1, 19, 0], listening: [10, 1, 19, 8, 0],
    ...
    happy: [2, 11, 17, 19, 8], curious: [3, 21, 0, 15], confused: [14, 5, 8],
    bored: [4, 22, 0], proud: [15, 8, 2, 11], shy: [0, 24, 8, 1], sad: [4, 13, 22],
  ...
  const EYE_HOLD_MS = {
    sleeping: [6000, 10000], waking: [800, 800], idle: [2800, 5200],
    listening: [1800, 3400], thinking: [2000, 3600], searching: [1000, 1800],
    working: [1800, 3200], excited: [1100, 2000], surprised: [2500, 4000],
    suspicious: [2600, 4500], angry: [2200, 3800], drowsy: [4000, 8000],
    happy: [1600, 3000], curious: [1800, 3200], confused: [2200, 3800],
    bored: [3500, 6000], proud: [2000, 3800], shy: [1800, 3400],
  ...
  const BLINK_MS = {
    sleeping: null, waking: null, idle: [2400, 5200], listening: [1800, 4200],
    thinking: [3500, 7000], searching: [1600, 4000], working: [2800, 5500],
    excited: [2000, 4000], surprised: [1800, 3500], suspicious: [4500, 8000],
    angry: [3500, 7000], drowsy: null, happy: [1600, 3600], curious: [2500, 5500],
    confused: [2800, 5500], bored: [4000, 8000], proud: [2000, 4200],
    shy: [1800, 4000], sad: [4000, 8000], laughing: [2500, 5000],
  ...
  const WINK_STATES = new Set(["idle", "happy", "excited", "curious", "playful", "proud", "shy", "listening"]);
